...
def line_search_wolfe(model, xk, pk, gfk=None, old_fval=None,
                      old_old_fval=None, args=(), c1=1e-4, c2=0.9, amax=None,
                      extra_condition=None, maxiter=1e4):
    """Find alpha that satisfies strong Wolfe conditions.

        Parameters
        ----------
        model: contain information about f_cuntion, gradient of f
        xk : ndarray
            Starting point.
        pk : ndarray
    ...
    if extra_condition is not None:
        ...
        extra_condition2 = None # type: ignore

    alpha_star, phi_star, old_fval, derphi_star = scalar_search_wolfe2(
            phi, derphi, old_fval, old_old_fval, derphi0, c1, c2, amax,
            extra_condition2, maxiter=maxiter) # type: ignore
...
def scalar_search_wolfe2(phi, derphi, phi0=None,
                         ...
                         extra_condition=None, maxiter=1e4): # type: ignore
    """Find alpha that satisfies strong Wolfe conditions.
